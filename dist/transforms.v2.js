...
var render = function render(expression, baseNode, options) {
    ...
    var tree = (_parseTree2.default)(expression, settings);
    var node = (_buildTree2.default)(tree, expression, settings).toNode();
...
var renderToString = function renderToString(expression, options) {
    ...
    var tree = (_parseTree2.default)(expression, settings);
    return (_buildTree2.default)(tree, expression, settings).toMarkup();
};
...
var generateParseTree = function generateParseTree(expression, options) {
    var settings = new _Settings2.default(options);
    return (_parseTree2.default)(expression, settings);
};
...
var Token = function () {
    function Token(text, start, end, lexer) {
        (_classCallCheck3.default)(this, Token);
...
var Lexer = function () {
    function Lexer(input) {
        (_classCallCheck3.default)(this, Lexer);
    ...
    (_createClass3.default)(Lexer, [{
        ...
        value: function lex() {
            ...
            var match = (_matchAt2.default)(tokenRegex, input, pos);
            if (match === null) {
...
var MacroExpander = function () {
    function MacroExpander(input, macros) {
        (_classCallCheck3.default)(this, MacroExpander);

        this.lexer = new _Lexer2.default(input);
        this.macros = (_objectAssign2.default)({}, _macros2.default, macros);
    ...
    (_createClass3.default)(MacroExpander, [{
        key: "nextToken",
...
var Options = function () {
    function Options(data) {
        (_classCallCheck3.default)(this, Options);
...
var ParseError = function ParseError(message, token) {
    (_classCallCheck3.default)(this, ParseError);
...
var ParseNode = function ParseNode(type, value, mode, firstToken, lastToken) {
    (_classCallCheck3.default)(this, ParseNode);
...
var Parser = function () {
    function Parser(input, settings) {
        (_classCallCheck3.default)(this, Parser);
...
var Settings = function Settings(options) {
  (_classCallCheck3.default)(this, Settings);
...
var Style = function () {
    function Style(id, size, cramped) {
        (_classCallCheck3.default)(this, Style);
...
var buildExpression = function buildExpression(expression, options, isRealGroup) {
        ...
        if (spaces) {
            ...
            if (_i < groups.length) {
                ...
                if (groups[_i] instanceof _domTree2.default.symbolNode) {
                    groups[_i] = (_buildCommon.makeSpan)([].concat(groups[_i].classes), [groups[_i]]);
                }
    ...
    for (var _i3 = 0; _i3 < groups.length; _i3++) {
        if (groups[_i3].value === "\u0338" && _i3 + 1 < groups.length) {
            ...
            var container = (_buildCommon.makeSpan)(classes, children);
...
var makeNullDelimiter = function makeNullDelimiter(options, classes) {
    ...
    return (_buildCommon.makeSpan)(classes.concat(moreClasses));
};
...
groupTypes.ordgroup = function (group, options) {
    return (_buildCommon.makeSpan)(["mord"], buildExpression(group.value, options, true), options);
};
...
groupTypes.text = function (group, options) {
    ...
    return (_buildCommon.makeSpan)(["mord", "text"], inner, newOptions);
};
...
groupTypes.supsub = function (group, options) {
    ...
    return (_buildCommon.makeSpan)([mclass], [base, (_buildCommon.makeSpan)(["msupsub"], [supsub])], options);
};
...
groupTypes.genfrac = function (group, options) {
    ...
    return (_buildCommon.makeSpan)(["mord"].concat(newOptions.sizingClasses(options)), [leftDelim, (_buildCommon.makeSpan)(["mfrac"], [frac]), rightDelim], options);
};
...
groupTypes.array = function (group, options) {
    ...
    c < nc || colDescrNum < colDescriptions.length; ++c, ++colDescrNum) {
        ...
        while (colDescr.type === "separator") {
            ...
            // between them.
            if (!firstSeparator) {
                colSep = (_buildCommon.makeSpan)(["arraycolsep"], []);
                colSep.style.width = options.fontMetrics().doubleRuleSep + "em";
                cols.push(colSep);
            }

            if (colDescr.separator === "|") {
                var separator = (_buildCommon.makeSpan)(["vertical-separator"], []);
        ...
        col = (_buildCommon.makeSpan)(["col-align-" + (colDescr.align || "c")], [col]);
        cols.push(col);
    ...
    body = (_buildCommon.makeSpan)(["mtable"], cols);
    return (_buildCommon.makeSpan)(["mord"], [body], options);
};
...
groupTypes.spacing = function (group, options) {
    if (group.value === "\\ " || group.value === "\\space" || group.value === " " || group.value === "~") {
        ...
        if (group.mode === "text") {
            ...
            return (_buildCommon.makeSpan)(["mspace"], [_buildCommon2.default.mathsym(group.value, group.mode, options)], options);
        }
    } else {
        // Other kinds of spaces are of arbitrary width. We use CSS to
        // generate these.
        return (_buildCommon.makeSpan)(["mspace", _buildCommon2.default.spacingFunctions[group.value].className], [], options);
    }
};

groupTypes.llap = function (group, options) {
    var inner = (_buildCommon.makeSpan)(["inner"], [buildGroup(group.value.body, options)]);
    var fix = (_buildCommon.makeSpan)(["fix"], []);
    return (_buildCommon.makeSpan)(["mord", "llap"], [inner, fix], options);
};

groupTypes.rlap = function (group, options) {
    var inner = (_buildCommon.makeSpan)(["inner"], [buildGroup(group.value.body, options)]);
    var fix = (_buildCommon.makeSpan)(["fix"], []);
    return (_buildCommon.makeSpan)(["mord", "rlap"], [inner, fix], options);
};
...
groupTypes.op = function (group, options) {
    ...
    if (group.value.symbol) {
        ...
        if (inner.length === 1 && inner[0] instanceof _domTree2.default.symbolNode) {
            ...
            base = (_buildCommon.makeSpan)(["mop"], inner, options);
        }
    } else {
        ...
        base = (_buildCommon.makeSpan)(["mop"], output, options);
    }
    ...
    if (hasLimits) {
        ...
        base = (_buildCommon.makeSpan)([], [base]);
        ...
        return (_buildCommon.makeSpan)(["mop", "op-limits"], [finalGroup], options);
    } else {
        if (baseShift) {
...
groupTypes.mod = function (group, options) {
    ...
    if (group.value.modType === "bmod") {
        ...
        if (!options.style.isTight()) {
            inner.push((_buildCommon.makeSpan)(["mspace", "negativemediumspace"], [], options));
        }
        inner.push((_buildCommon.makeSpan)(["mspace", "thickspace"], [], options));
    } else if (options.style.size === _Style2.default.DISPLAY.size) {
        inner.push((_buildCommon.makeSpan)(["mspace", "quad"], [], options));
    } else if (group.value.modType === "mod") {
        inner.push((_buildCommon.makeSpan)(["mspace", "twelvemuspace"], [], options));
    } else {
        inner.push((_buildCommon.makeSpan)(["mspace", "eightmuspace"], [], options));
    }
    ...
    if (group.value.modType !== "pod") {
        ...
        if (group.value.modType === "bmod") {
            inner.push((_buildCommon.makeSpan)(["mbin"], modInner, options));
            ...
            inner.push((_buildCommon.makeSpan)(["mspace", "sixmuspace"], [], options));
        }
    }
...
groupTypes.katex = function (group, options) {
    ...
    var k = (_buildCommon.makeSpan)(["k"], [_buildCommon2.default.mathsym("K", group.mode)], options);
    var a = (_buildCommon.makeSpan)(["a"], [_buildCommon2.default.mathsym("A", group.mode)], options);

    a.height = (a.height + 0.2) * 0.75;
    a.depth = (a.height - 0.2) * 0.75;

    var t = (_buildCommon.makeSpan)(["t"], [_buildCommon2.default.mathsym("T", group.mode)], options);
    var e = (_buildCommon.makeSpan)(["e"], [_buildCommon2.default.mathsym("E", group.mode)], options);

    e.height = e.height - 0.2155;
    e.depth = e.depth + 0.2155;

    var x = (_buildCommon.makeSpan)(["x"], [_buildCommon2.default.mathsym("X", group.mode)], options);

    return (_buildCommon.makeSpan)(["mord", "katex-logo"], [k, a, t, e, x], options);
};

var makeLineSpan = function makeLineSpan(className, options, thickness) {
    var line = (_buildCommon.makeSpan)([className], [], options);
...
groupTypes.overline = function (group, options) {
    ...
    return (_buildCommon.makeSpan)(["mord", "overline"], [vlist], options);
};
...
groupTypes.underline = function (group, options) {
    ...
    return (_buildCommon.makeSpan)(["mord", "underline"], [vlist], options);
};
...
groupTypes.sqrt = function (group, options) {
    ...
    if (inner instanceof _domTree2.default.documentFragment) {
        inner = (_buildCommon.makeSpan)([], [inner], options);
    }
    ...
    if (!group.value.index) {
        return (_buildCommon.makeSpan)(["mord", "sqrt"], [body], options);
    } else {
        ...
        // kerning
        var rootVListWrap = (_buildCommon.makeSpan)(["root"], [rootVList]);

        return (_buildCommon.makeSpan)(["mord", "sqrt"], [rootVListWrap, body], options);
    }
};
...
groupTypes.delimsizing = function (group, options) {
    ...
    if (delim === ".") {
        ...
        // show anything.
        return (_buildCommon.makeSpan)([group.value.mclass]);
    }
...
groupTypes.leftright = function (group, options) {
    ...
    return (_buildCommon.makeSpan)(["minner"], inner, options);
};
...
groupTypes.rule = function (group, options) {
    ...
    var rule = (_buildCommon.makeSpan)(["mord", "rule"], [], options);
...
groupTypes.accent = function (group, options) {
    ...
    if (!group.value.isStretchy) {
        ...
        accentBody = (_buildCommon.makeSpan)([], [accent]);
        accentBody = (_buildCommon.makeSpan)(["accent-body", accentClass], [accentBody]);
    ...
    var accentWrap = (_buildCommon.makeSpan)(["mord", "accent"], [accentBody], options);
...
groupTypes.horizBrace = function (group, options) {
    ...
    if (hasSupSub) {
        ...
        var vSpan = (_buildCommon.makeSpan)(["mord", group.value.isOver ? "mover" : "munder"], [vlist], options);
    ...
    return (_buildCommon.makeSpan)(["mord", group.value.isOver ? "mover" : "munder"], [vlist], options);
};
...
groupTypes.accentUnder = function (group, options) {
    ...
    return (_buildCommon.makeSpan)(["mord", "accentunder"], [vlist], options);
};
...
groupTypes.enclose = function (group, options) {
    ...
    if (label === "sout") {
        img = (_buildCommon.makeSpan)(["stretchy", "sout"]);
    ...
    if (/cancel/.test(label)) {
        ...
        return (_buildCommon.makeSpan)(["mord", "cancel-lap"], [vlist], options);
    } else {
        return (_buildCommon.makeSpan)(["mord"], [vlist], options);
    }
};
...
groupTypes.xArrow = function (group, options) {
    ...
    return (_buildCommon.makeSpan)(["mrel", "x-arrow"], [vlist], options);
};
...
groupTypes.mclass = function (group, options) {
    ...
    return (_buildCommon.makeSpan)([group.value.mclass], elements, options);
};
...
var buildGroup = function buildGroup(group, options, baseOptions) {
    ...
    if (groupTypes[group.type]) {
        ...
        if (baseOptions && options.size !== baseOptions.size) {
            groupNode = (_buildCommon.makeSpan)(options.sizingClasses(baseOptions), [groupNode], options);
...
var buildHTML = function buildHTML(tree, options) {
    ...
    tree = JSON.parse((_stringify2.default)(tree));

    // Build the expression contained in the tree
    var expression = buildExpression(tree, options, true);
    var body = (_buildCommon.makeSpan)(["base"], expression, options);

    // Add struts, which ensure that the top of the HTML element falls at the
    // height of the expression, and the bottom of the HTML element falls at the
    // depth of the expression.
    var topStrut = (_buildCommon.makeSpan)(["strut"]);
    var bottomStrut = (_buildCommon.makeSpan)(["strut", "bottom"]);
    ...
    var htmlNode = (_buildCommon.makeSpan)(["katex-html"], [topStrut, bottomStrut, body]);
...
var buildMathML = function buildMathML(tree, texExpression, options) {
    ...
    return (_buildCommon.makeSpan)(["katex-mathml"], [math]);
};
...
var buildTree = function buildTree(tree, expression, settings) {
    ...
    var mathMLNode = (_buildMathML2.default)(tree, expression, options);
    var htmlNode = (_buildHTML2.default)(tree, options);

    var katexNode = (_buildCommon.makeSpan)(["katex"], [mathMLNode, htmlNode]);

    if (settings.displayMode) {
        return (_buildCommon.makeSpan)(["katex-display"], [katexNode]);
    } else {
        return katexNode;
    }
};
...
var styleWrap = function styleWrap(delim, toStyle, options, classes) {
    ...
    var span = (_buildCommon.makeSpan)((classes || []).concat(newOptions.sizingClasses(options)), [delim], options);
...
var makeLargeDelim = function makeLargeDelim(delim, size, center, options, mode, classes) {
    ...
    var span = styleWrap((_buildCommon.makeSpan)(["delimsizing", "size" + size], [inner], options), _Style2.default.TEXT, options, classes);
    if (center) {
...
var makeInner = function makeInner(symbol, font, mode) {
    ...
    var inner = (_buildCommon.makeSpan)(["delimsizinginner", sizeClass], [(_buildCommon.makeSpan)([], [_buildCommon2.default.makeSymbol(symbol, font, mode)])]);
...
var makeStackedDelim = function makeStackedDelim(delim, heightTotal, center, options, mode, classes) {
    ...
    return styleWrap((_buildCommon.makeSpan)(["delimsizing", "mult"], [inner], newOptions), _Style2.default.TEXT, options, classes);
};
...
var span = function () {
    function span(classes, children, options) {
        (_classCallCheck3.default)(this, span);
...
var documentFragment = function () {
    function documentFragment(children) {
        (_classCallCheck3.default)(this, documentFragment);
    ...
    (_createClass3.default)(documentFragment, [{
        key: "toNode",
        value: function toNode() {
            // Create a fragment
...
var symbolNode = function () {
    function symbolNode(value, height, depth, italic, skew, classes, style) {
        (_classCallCheck3.default)(this, symbolNode);
    ...
    (_createClass3.default)(symbolNode, [{
        key: "tryCombine",
        value: function tryCombine(sibling) {
...
var MathNode = function () {
    function MathNode(type, children) {
        (_classCallCheck3.default)(this, MathNode);
    ...
    (_createClass3.default)(MathNode, [{
        key: "setAttribute",
...
var TextNode = function () {
    function TextNode(text) {
        (_classCallCheck3.default)(this, TextNode);
    ...
    (_createClass3.default)(TextNode, [{
        key: "toNode",
        value: function toNode() {
